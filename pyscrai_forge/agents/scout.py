        ...
        try:
            ...
            for item in data.get("entities", []):
                try:
                    ...
                    # Use temporary stub ID - real IDs are generated by Analyst
                    # This prevents Scout from consuming entity IDs from the counter
                    entity_id = item.get("id", f"stub_{item.get('name', 'unknown')}")
